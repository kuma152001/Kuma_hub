--[[ 
    ...
    ---------------------------------------------------
    Phiên bản: V2.4.4 (Compact Inputs & Recipe Board)
    Changelogs:
...
task.spawn(function()
    ...
    function KumaUI:CreateWindow(Settings)
        ...
        Screen.Name = "KumaHub_Cultivation_Compact"
        ...
        function WindowFunctions:CreateTab(Name, Icon)
            ...
            function TabFunctions:CreateMultiInput(Infos)
                ...
                Container.Size = UDim2.new(1, 0, 0, ItemHeight)
                ...
                for _, Info in ipairs(Infos) do
                    ...
                    Box.BackgroundTransparency = 0.5
                    Box.TextColor3 = Color3.fromRGB(255, 140, 0)
                    Box.PlaceholderText = Info.Name
                    Box.Text = ""
                    Box.Font = Enum.Font.Gotham
                    Box.TextSize = 12 * SizeScale
                    Box.TextXAlignment = Enum.TextXAlignment.Center
                    Box.Parent = Container
                    Instance.new("UICorner", Box).CornerRadius = UDim.new(0, 4)
                    
                    if Info.PlaceholderText then Box.PlaceholderText = Info.Name .. "\n(" .. Info.PlaceholderText .. ")" end
            ...
            function TabFunctions:CreateDropdown(Info) 
                ...
                MainBtn.MouseButton1Click:Connect(function()
                    ...
                    if IsOpen then
                        ...
                        DropContainer.Size = UDim2.new(Width, 0, 0, ItemHeight + ListHeight + 5)
                        Arrow.Rotation = 180
                    else
                        DropContainer.Size = UDim2.new(Width, 0, 0, ItemHeight)
                        Arrow.Rotation = 0
            ...
            function TabFunctions:CreateRecipeBoard(Recipes)
                ...
                Header.Text = "📖 DANH SÁCH CÔNG THỨC (TRA CỨU)"
                Header.Size = UDim2.new(1, 0, 0, 25)
                Header.BackgroundTransparency = 1
                Header.TextColor3 = Color3.fromRGB(255, 170, 0)
                Header.Font = Enum.Font.GothamBold
                Header.TextSize = 13
                Header.Parent = BoardFrame
                
                local Scroller = Instance.new("ScrollingFrame")
                Scroller.Position = UDim2.new(0, 5, 0, 30)
                Scroller.Size = UDim2.new(1, -10, 1, -35)
                Scroller.BackgroundTransparency = 1
                Scroller.ScrollBarThickness = 3
                Scroller.Parent = BoardFrame
    ...
    local Window = Rayfield:CreateWindow({
       ...
       LoadingSubtitle = "V2.4.4 Compact",
